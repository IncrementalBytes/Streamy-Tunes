 ...
 */
package net.whollynugatory.streamytunes.android.service.notifications;
...
public class MediaNotificationManager {
  ...
  private static final String TAG = BaseActivity.BASE_TAG + MediaNotificationManager.class.getSimpleName();

  private static final String CHANNEL_ID = "net.whollynugatory.streamytunes.android.channel";
  ...
  public MediaNotificationManager(MusicService service) {
    ...
    Log.d(TAG, "++MediaNotificationManager(MusicService)");
    mService = service;
  ...
  public Notification getNotification(MediaMetadataCompat metadata, @NonNull PlaybackStateCompat state, MediaSessionCompat.Token token) {
    ...
    Log.d(TAG, "++getNotification(MediaMetadataCompat, PlaybackStateCompat, MediaSessionCompat.Token)");
  ...
  private NotificationCompat.Builder buildNotification(
    ...
    Log.d(TAG, "++buildNotification(PlaybackStateCompat, MediaSessionCompat.Token, boolean, MediaDescriptionCompat)");
    ...
    builder.setStyle(
      ...
      .setSmallIcon(R.drawable.ic_song_dark)
      ...
      .setLargeIcon(MusicLibrary.getAlbumBitmap(mediaDescription.getMediaId()))
  ...
  private PendingIntent createContentIntent() {
    ...
    return PendingIntent.getActivity(mService, BaseActivity.REQUEST_NOTIFICATION, openUI, PendingIntent.FLAG_CANCEL_CURRENT);
  }
}
